defmodule Hello.Pipeline.Inventory do
  use Broadway

  require Logger

  alias Broadway.Message
  alias Hello.Pipeline
  alias Hello.Pipeline.InventoryHandler

  def start_link(_opts) do
    redpanda_host = Application.fetch_env!(:hello, :redpanda_host)
    redpanda_port = Application.fetch_env!(:hello, :redpanda_port)
    redpanda_group = Application.fetch_env!(:hello, :redpanda_group_default)

    topic_name = Application.fetch_env!(:hello, :redpanda_topic_inventory)
  ...
  def push_items(merchant_id, item_count) do
    ...
    topic = Application.fetch_env!(:hello, :redpanda_topic_inventory)
